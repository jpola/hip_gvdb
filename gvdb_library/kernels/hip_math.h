//-----------------------------------------------------------------------------
// cuda_math.cuh
// Copyright 1993 NVIDIA Corporation
...
inline __device__ __host__ float2 smoothstep(float2 a, float2 b, float2 x)
{
    ...
    return (y*y*(make_float2(3.0f, 3.0f) - (make_float2(2.0f, 2.0f)*y)));
}
...
inline __device__ __host__ float4 smoothstep(float4 a, float4 b, float4 x)
{
    ...
    return (y*y*(make_float4(3.0f, 3.0f, 3.0f, 3.0f) - (make_float4(2.0f, 2.0f, 2.0f, 2.0f)*y)));
}
